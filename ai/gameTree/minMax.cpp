...
GameState *minMaxPickMove(GameState *inCurrentState, MinOrMax inSide, int inDepthLimit)
{
    ...
    */
    ...
    SimpleVector<GameState *> possibleMoves = inCurrentState->getPossibleMoves();
    ...
    for (int i = 0; i < numMoves; i++)
    {
        ...
        int score = minMax(move, switchSide(inSide), inDepthLimit);
        /*
...
SimpleVector<GameState *> sortStatesByScore(SimpleVector<GameState *> inStates, MinOrMax inSide)
{
...
int minMax(GameState *inCurrentState, MinOrMax inSide, int inDepthLimit, int inMin, int inMax)
{
    ...
    if (inSide == max)
    {
        ...
        for (int i = 0; i < numMoves; i++)
        {
            ...
            int score = minMax(move, switchSide(inSide), inDepthLimit - 1, bestScoreSeen, inMax);
            delete move;
    ...
    else
    {
        ...
        for (int i = 0; i < numMoves; i++)
        {
            ...
            int score = minMax(move, switchSide(inSide), inDepthLimit - 1, inMin, bestScoreSeen);
