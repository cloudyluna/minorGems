...
class Crossbreedable
{
  ...
  public:
     ...
     */
    virtual void *crossbreed(Crossbreedable *inOther, float inFractionOther, float inMutationProb,
     ...
     *   individual mutation, in [0..1].
     */
    virtual void mutate(float inMutationProb, float inMaxMutationMagnitude) = 0;
     ...
     */
    void setGeneration(Crossbreedable *inParentA, Crossbreedable *inParentB);
...
inline Crossbreedable::Crossbreedable() : mGeneration(0)
{
}
...
inline void Crossbreedable::setGeneration(Crossbreedable *inParentA, Crossbreedable *inParentB)
{
