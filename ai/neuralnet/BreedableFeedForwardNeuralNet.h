 ...
 * @author Jason Rohrer
 */
class BreedableFeedForwardNeuralNet : public FeedForwardNeuralNet, public Crossbreedable
{
  ...
  public:
     ...
     */
    BreedableFeedForwardNeuralNet(int inNumInputs, int inNumHiddenLayers, int *inNeuronsPerLayer, int inNumOutputs,
     ...
     *   during all crossbreeding and mutation.
     */
    BreedableFeedForwardNeuralNet(FILE *inInputFile, RandomSource *inRandSource);
     ...
     */
    void *crossbreed(Crossbreedable *inOther, float inFractionOther, float inMutationProb,
