...
BreedingDoubleExampleTrainer::BreedingDoubleExampleTrainer(ErrorEvaluator *inErrorEvaluator)
...
int BreedingDoubleExampleTrainer::train(int inMaxNumRounds, float inMutationProb, float inMaxMutationMagnitude,
                                        float *inOutErrors)
{
    ...
    for (r = 0; r < inMaxNumRounds; r++)
    {
        ...
        {
            DoubleTrainingExample *example = dynamic_cast<DoubleTrainingExample *>(mExamples[e]);
            if (example == 0)
            {
        ...
        for (n = 0; n < mPopulationSize; n++)
        {
            ...
            BreedableFeedForwardNeuralNet *network = dynamic_cast<BreedableFeedForwardNeuralNet *>(mPopulation[n]);
            if (network == 0)
            {
                // cast failed.
            ...
            populationError[n] = mErrorEvaluator->evaluate(correctOutputs, individualOutput, mExampleSetSize);
            /*
            if( n == mPopulationSize-1 ) {
        ...
        Crossbreedable *crossbreedableTopNetwork = dynamic_cast<Crossbreedable *>(mPopulation[0]);
        ...
        */
        BreedableFeedForwardNeuralNet *toFileTopNetwork = dynamic_cast<BreedableFeedForwardNeuralNet *>(mPopulation[0]);
        ...
        */
        ...
        int remainder = mPopulationSize - (numToBreed + (numToBreed * (numToBreed + 1)) / 2);
        ...
        for (int a = 0; a < numToBreed; a++)
        {
            for (int b = a + 1; b < numToBreed; b++)
            {
                ...
                BreedableFeedForwardNeuralNet *networkToDelete =
                    dynamic_cast<BreedableFeedForwardNeuralNet *>(mPopulation[indNextReplace]);
                ...
                BreedableFeedForwardNeuralNet *network = dynamic_cast<BreedableFeedForwardNeuralNet *>(mPopulation[a]);
                BreedableFeedForwardNeuralNet *otherNetwork =
                    dynamic_cast<BreedableFeedForwardNeuralNet *>(mPopulation[b]);
                ...
                void *offspring =
                    ...
                    network->crossbreed(otherNetwork, 0.5f, inMutationProb, inMaxMutationMagnitude);
