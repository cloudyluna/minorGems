 ...
 * @author Jason Rohrer
 */
class BreedingDoubleExampleTrainer : public PopulationTrainer, public ExampleTrainer
{
  ...
  public:
     ...
     *
     */
    int train(int inMaxNumRounds, float inMutationProb, float inMaxMutationMagnitude, float *inOutErrors);
...
inline void BreedingDoubleExampleTrainer::setBestFileName(char *inBestFileName)
{
