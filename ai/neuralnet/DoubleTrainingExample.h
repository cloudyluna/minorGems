...
class DoubleTrainingExample : public TrainingExample
{
  public:
     ...
     */
    DoubleTrainingExample(double *inInputs, double *inOutputs, int inNumInputs, int inNumOutputs);
...
inline DoubleTrainingExample::DoubleTrainingExample(double *inInputs, double *inOutputs, int inNumInputs,
                                                    int inNumOutputs)
    : mInputs(inInputs), mOutputs(inOutputs), mNumInputs(inNumInputs), mNumOutputs(inNumOutputs)
{
}
