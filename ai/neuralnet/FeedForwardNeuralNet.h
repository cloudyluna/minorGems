...
class FeedForwardNeuralNet : public DoubleNeuralNet
{
  ...
  public:
     ...
     */
    FeedForwardNeuralNet(int inNumInputs, int inNumHiddenLayers, int *inNeuronsPerLayer, int inNumOutputs);
     ...
     */
    void setThresholdValue(int inLayer, int inNeuron, double inThresholdValue);
     ...
     */
    void setWeight(int inLayerA, int inNeuronA, int inNeuronB, double inWeight);
...
inline void FeedForwardNeuralNet::setThreshold(int inLayer, int inNeuron, Threshold *inThreshold)
{

    mNeuronThresholds[inLayer][inNeuron] = inThreshold;
}

inline Threshold *FeedForwardNeuralNet::getThreshold(int inLayer, int inNeuron)
{

    return mNeuronThresholds[inLayer][inNeuron];
}

inline void FeedForwardNeuralNet::setThresholdValue(int inLayer, int inNeuron, double inThresholdValue)
{

    mNeuronThresholdValues[inLayer][inNeuron] = inThresholdValue;
}

inline double FeedForwardNeuralNet::getThresholdValue(int inLayer, int inNeuron)
{

    return mNeuronThresholdValues[inLayer][inNeuron];
}

inline void FeedForwardNeuralNet::setWeight(int inLayerA, int inNeuronA, int inNeuronB, double inWeight)
{

    mWeights[inLayerA][inNeuronA][inNeuronB] = inWeight;
}

inline double FeedForwardNeuralNet::getWeight(int inLayerA, int inNeuronA, int inNeuronB)
{
