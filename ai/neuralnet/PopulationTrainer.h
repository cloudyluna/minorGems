...
inline void PopulationTrainer::setPopulation(NeuralNet **inPopulation, int inPopulationSize)
{
...
{
    memcpy((void *)outPopulation, (void *)mPopulation, mPopulationSize * sizeof(void *));
}
