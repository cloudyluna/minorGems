...
class ImageRectangle
{
  ...
  public:
     ...
     */
    ImageRectangle(double inXStart, double inXEnd, double inYStart, double inYEnd);
};

inline ImageRectangle::ImageRectangle(double inXStart, double inXEnd, double inYStart, double inYEnd)
    : mXStart(inXStart), mXEnd(inXEnd), mYStart(inYStart), mYEnd(inYEnd)
{
}
