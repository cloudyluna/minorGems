...
class ImageStatistics
{
  ...
  public:
     ...
     */
    static double fractionOverThreshold(Image *inImage, int inChannel, ImageRectangle *inRectangle, double inThreshold);
     ...
     */
    static double fractionUnderThreshold(Image *inImage, int inChannel, ImageRectangle *inRectangle,
                                         double inThreshold);
     ...
     */
    static double differenceMap(Image *inImageOne, Image *inImageTwo, Image *outImage);
     ...
     */
    static long thresholdMap(Image *inImage, double threshold, int channelNumber, Image *outImage);
     ...
     */
    static double fractionNearColor(Image *inThreeChannelImage, Color *inColor, double inTolerance);
     ...
     *   The returned value is in [0,1].
     */
    static void centerOfColor(Image *inThreeChannelImage, Color *inColor, double inTolerance, double *outCenterX,
                              double *outCenterY);
     ...
     */
    static double fractionNearValue(Image *inImage, int inChannel, double inValue, double inTolerance,
                                    Image *ignoreMask);
     ...
     *   calculations.
     */
    static void centerOfValue(Image *inImage, int inChannel, double inValue, double inTolerance, double *outCenterX,
                              double *outCenterY, Image *ignoreMask);
     ...
     *   Must be destroyed by caller.
     */
    static Color *averageColor(Image *inThreeChannelImage, ImageRectangle *inRectangle);
     ...
     */
    static double averageValue(Image *inImage, int inChannel, ImageRectangle *inRectangle, Image *ignoreMask);
...
inline double ImageStatistics::fractionOverThreshold(Image *inImage, int inChannel, ImageRectangle *inRectangle,
                                                     double inThreshold)
{
...
inline double ImageStatistics::differenceMap(Image *inImageOne, Image *inImageTwo, Image *outImage)
{
...
inline long ImageStatistics::thresholdMap(Image *inImage, double threshold, int channelNumber, Image *outImage)
{
...
inline double ImageStatistics::fractionUnderThreshold(Image *inImage, int inChannel, ImageRectangle *inRectangle,
                                                      double inThreshold)
{

    // this is just the opposite of fractionOver
    return 1 - fractionOverThreshold(inImage, inChannel, inRectangle, inThreshold);
}

inline double ImageStatistics::fractionNearColor(Image *inThreeChannelImage, Color *inColor, double inTolerance)
{
    ...
    {
        printf("fractionNearColor requires a 3-channel image as input.\n");
        return 0;
    }
    ...
    for (int i = 0; i < numPixels; i++)
    {
        ...
        if (fabs(redChannel[i] - red) <= inTolerance && fabs(greenChannel[i] - green) <= inTolerance &&
...
inline void ImageStatistics::centerOfColor(Image *inThreeChannelImage, Color *inColor, double inTolerance,
                                           double *outCenterX, double *outCenterY)
{
    ...
    if (inImage->getNumChannels() != 3)
    {
        printf("centerOfColor requires a 3-channel image as input.\n");
        return;
    }
...
inline double ImageStatistics::fractionNearValue(Image *inImage, int inChannel, double inValue, double inTolerance,
                                                 Image *ignoreMask)
{
    ...
    ImageUtilities::imageToBMPFile(matchImage, matchFileName);
...
inline void ImageStatistics::centerOfValue(Image *inImage, int inChannel, double inValue, double inTolerance,
                                           double *outCenterX, double *outCenterY, Image *ignoreMask)
{
...
inline Color *ImageStatistics::averageColor(Image *inThreeChannelImage, ImageRectangle *inRectangle)
{
    ...
    if (inImage->getNumChannels() != 3)
    {
        printf("averageColor requires a 3-channel image as input.\n");
        return NULL;
    }

    Image *allOnesMask = new Image(inImage->getWidth(), inImage->getHeight(), 1);
    ...
    Color *returnColor = new Color((float)redAverage, (float)greenAverage, (float)blueAverage);
...
inline double ImageStatistics::averageValue(Image *inImage, int inChannel, ImageRectangle *inRectangle,
                                            Image *ignoreMask)
{
...
inline Image *ImageStatistics::RGBtoHSB(Image *inRGBImage)
{
    ...
    {
        printf("RGBtoHSB requires a 3-channel image as input.\n");
        return NULL;
    }
