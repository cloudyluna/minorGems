...
class RohrerMoveGenerator : public StereoMoveGenerator
{
  ...
  public:
     ...
     */
    RohrerMoveGenerator(double inDepthThreshold, double inMinDepthFraction);
...
inline RohrerMoveGenerator::RohrerMoveGenerator(double inDepthThreshold, double inMinDepthFraction)
    : mDepthThreshold(inDepthThreshold), mMinDepthFraction(inMinDepthFraction),
...
inline void RohrerMoveGenerator::generateMoves(Image *inLeftImage, Image *inRightImage, Image *inStereoData,
                                               MoveProcessor *inMoveProcessor)
{

    double fraction = ImageStatistics::fractionUnderThreshold(inStereoData, 0, mRectangle, mDepthThreshold);
