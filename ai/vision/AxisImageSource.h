...
class AxisImageSource : public ImageSource
{
  ...
  public:
     ...
     */
    AxisImageSource(HostAddress *inServerAddress, int inImageWidth, int inImageHeight, int inCompression);
...
inline AxisImageSource::AxisImageSource(HostAddress *inServerAddress, int inImageWidth, int inImageHeight,
                                        int inCompression)
    : mServerAddress(inServerAddress), mConverter(new JPEGImageConverter(50)), mImageWidth(inImageWidth),
      mImageHeight(inImageHeight), mCompression(inCompression)
{
...
inline Image *AxisImageSource::getNextImage()
{
    ...
    Socket *mServerSocket = SocketClient::connectToServer(mServerAddress);
    ...
    */
    ...
    sprintf(requestBuffer, "GET /jpg/image.jpg HTTP/1.0 \r\nAccept: image/jpeg \r\n\r\n");
