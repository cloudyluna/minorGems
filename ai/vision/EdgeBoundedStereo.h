...
class EdgeBoundedStereo : public Stereo
{
  ...
  public:
     ...
     */
    EdgeBoundedStereo(int inMaxDisparity, EdgeDetector *inDetector, RandomSource *inRandSource);
...
inline EdgeBoundedStereo::EdgeBoundedStereo(int inMaxDisparity, EdgeDetector *inDetector, RandomSource *inRandSource)
    : Stereo(inMaxDisparity), mEdgeDetector(inDetector), mRandSource(inRandSource)
{
}
...
Stereo *EdgeBoundedStereo::copy()
{
    ...
    return new EdgeBoundedStereo(mMaxDisparity, mEdgeDetector->copy(), mRandSource);
}

// note that this code is a little messy, because it was copied
// from	edgeStereo.cpp without much modification.
inline Image *EdgeBoundedStereo::computeDepthMap(Image *inLeft, Image *inRight)
{
