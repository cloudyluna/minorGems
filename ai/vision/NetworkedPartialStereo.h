...
inline NetworkedPartialStereo::NetworkedPartialStereo(SocketStream *inStream) : PartialStereo(1), mStream(inStream)
{
...
inline Image *NetworkedPartialStereo::computeDepthMap(Image *inLeft, Image *inRight)
{
