...
class PartialStereo : public Stereo
{
  ...
  public:
     ...
     */
    void setRange(double inXStart, double inXEnd, double inYStart, double inYEnd);
...
inline PartialStereo::PartialStereo(int inMaxDisparity)
    : Stereo(inMaxDisparity), mYStart(0), mYEnd(1.0), mXStart(0), mXEnd(1.0)
{
}

inline void PartialStereo::setRange(double inXStart, double inXEnd, double inYStart, double inYEnd)
{
    mXStart = inXStart;
    mXEnd = inXEnd;
    mYStart = inYStart;
