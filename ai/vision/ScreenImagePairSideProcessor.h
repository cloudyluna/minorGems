...
inline ScreenImagePairSideProcessor::ScreenImagePairSideProcessor(int inWidth, int inHeight)
    : mWidth(inWidth), mHeight(inHeight), mScreen(new ScreenGraphics(inWidth, inHeight))
{
...
inline ScreenImagePairSideProcessor::~ScreenImagePairSideProcessor()
{
...
inline void ScreenImagePairSideProcessor::process(Image *inLeft, Image *inRight)
{
