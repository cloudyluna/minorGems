...
inline ScreenStereoProcessor::ScreenStereoProcessor(int inWidth, int inHeight)
...
inline ScreenStereoProcessor::~ScreenStereoProcessor()
{
...
inline void ScreenStereoProcessor::addData(Image *inLeftImage, Image *inRightImage, Image *inStereoData)
{
