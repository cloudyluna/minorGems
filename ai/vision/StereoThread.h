...
class StereoThread : public Thread
{
  ...
  public:
     ...
     */
    StereoThread(Stereo *inStereo, Image *inLeft, Image *inRight, Image **outResult);
...
inline StereoThread::StereoThread(Stereo *inStereo, Image *inLeft, Image *inRight, Image **outResult)
    : mStereo(inStereo), mLeft(inLeft), mRight(inRight), mOutResult(outResult)
{
}
