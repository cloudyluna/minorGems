...
inline SusanEdgeDetector::SusanEdgeDetector(int inThreshold) : mThreshold(inThreshold)
{
}
...
inline Image *SusanEdgeDetector::findEdges(Image *inImage)
{
    ...
    susan_find_edges_thresh(charChannel, wide, high, charEdges, orientations, mThreshold);
