...
inline ThreadedMultiChannelStereo::ThreadedMultiChannelStereo(Stereo *inStereo) : MultiChannelStereo(inStereo)
{
}
...
inline Stereo *ThreadedMultiChannelStereo::copy()
{
    ...
    ThreadedMultiChannelStereo *returnValue = new ThreadedMultiChannelStereo(mStereo->copy());

    return returnValue;
}

inline Image *ThreadedMultiChannelStereo::computeDepthMap(Image *inLeft, Image *inRight)
{
