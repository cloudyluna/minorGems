...
extern "C" void susan_find_edges_thresh(uchar *in, int x_size, int y_size, uchar *binEdges, EDGE_ORIENTATION *orient,
                                        int thresh);
 ...
 *
 */
void edgeStereoHausdorff(P_M *inL, P_M *inR, P_M *out, int windowSize, int maxDisparity, int edgeThreshold,
                         int hdDilate)
{
    ...
    for (int y = startBox; y < h - boxRad; y++)
