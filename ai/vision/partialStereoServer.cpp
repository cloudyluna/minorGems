...
int main(int inNumArgs, char **inArgs)
{
    ...
    LocalWindowStereo *stereo = new LocalWindowStereo(30, windowSize, randSource);
    ...
    while (stream->InputStream::getLastError() == NULL && stream->OutputStream::getLastError() == NULL)
    {
