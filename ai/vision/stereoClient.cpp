...
int main(int inNumArgs, char **inArgs)
{
    ...
    HostAddress *leftServerAddress = new HostAddress(leftAddressString, leftPort);
    ...
    HostAddress *rightServerAddress = new HostAddress(rightAddressString, rightPort);
    ...
    HostAddress *controlServerAddress = new HostAddress(controlAddressString, controlPort);
    ...
    */
    ...
    else if (stereoAlgorithmNumber == 1)
    {
        ...
        for (int c = 0; c < numConnections; c++)
        {
            ...
            HostAddress *address = new HostAddress(addressString, addressLength, port);
    ...
    case 0:
        ...
        moveGenerator = new DefaultMoveGenerator();
        break;
    case 1:
        printf("Using TavanMoveGenerator.\n");
        moveGenerator = new TavanMoveGenerator();
        break;
    case 2:
        printf("Using RohrerMoveGenerator.\n");
        moveGenerator = new RohrerMoveGenerator(0.3, 0.4);
        break;
    case 3:
        printf("Using WaypointMoveGenerator.\n");
        waypointConfigFileName = new char[99];
        numRead = fscanf(iniFile, "%s", waypointConfigFileName);
        ...
        waypointConfigFile = fopen(waypointConfigFileName, "r");
        ...
        moveGenerator = new WaypointMoveGenerator(waypointConfigFile, outputFiles);
    ...
    AxisMoveProcessor *moveProcessor = new AxisMoveProcessor(controlServerAddress);

    MovementStereoProcessor *stereoProcessor = new MovementStereoProcessor(moveGenerator, moveProcessor, outputFiles);

    DefaultImagePairSideProcessor *imageProcessor = new DefaultImagePairSideProcessor();

    AxisImageSource *leftSource = new AxisImageSource(leftServerAddress, 320, 240, 50);
    AxisImageSource *rightSource = new AxisImageSource(rightServerAddress, 320, 240, 50);

    StereoClient *client = new StereoClient(leftSource, rightSource, stereo, stereoProcessor, imageProcessor);
