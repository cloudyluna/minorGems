...
int main(int inNumArgs, char **inArgs)
{
    ...
    for (int c = 0; c < numConnections; c++)
    {
        ...
        HostAddress *address = new HostAddress(addressString, port);
    ...
    NetworkedStereo *stereo = new NetworkedStereo(streams, numConnections);
    ...
    Image *stereoImage = stereo->computeDepthMap(leftGrayImage, rightGrayImage);
    ...
    Image *threeChannelImage = ImageColorConverter::grayscaleToRGB(stereoImage);
