...
int main(int inNumArgs, char **inArgs)
{
    ...
    LocalWindowStereo *stereo = new LocalWindowStereo(7, 5, randSource);
    ...
    */
    ...
    StereoClient *client =
        new StereoClient(leftServerAddress, rightServerAddress, stereo, stereoProcessor, imageProcessor);
