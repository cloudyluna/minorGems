...
int main()
{
    ...
    checkHash(millionAs, "A million repetions of \'a\'", correctMillionHash);

    delete[] millionAs;

    char *testString = strdup("this is a very long chat message, so long in fact that we are going to put this program "
                              "through the mill even longer: this is a very long chat message, so long in fact that we "
                              "are going to put this program through the mill");
