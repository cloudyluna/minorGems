...
class BitMemory
{
  ...
  public:
     ...
     */
    unsigned char *getMemoryRange(unsigned long inRangeStart, unsigned long inRangeEnd,
     ...
     *   char corresponds to the inRangeStart memory location.
     */
    void setMemoryRange(unsigned long inRangeStart, unsigned long inRangeEnd, unsigned char *inRangeContents);
     ...
     * @param inRangeEnd end of range in bits, inclusive.
     */
    void clearMemoryRange(unsigned long inRangeStart, unsigned long inRangeEnd);
...
inline BitMemory::BitMemory(unsigned long inNumBits)
    : mNumBits(inNumBits), mMemoryArray(new unsigned char[inNumBits >> 3])
{ // divide by 8
}
