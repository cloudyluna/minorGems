...
class InstructionSet
{
  public:
     ...
     */
    virtual unsigned long stepProgram(BitMemory *inMemory, unsigned long inProgramCounter) = 0;
...
inline InstructionSet::InstructionSet() : mBitsInAddress(8)
{
}

inline unsigned long InstructionSet::setMemorySize(unsigned long inNumBits)
{
