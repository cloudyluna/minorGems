 ...
 */
class SimpleInstructionSet : public InstructionSet, public CommonInstructionSet
{

  public:
    // implements the InstructionSet interface
    unsigned long stepProgram(BitMemory *inMemory, unsigned long inProgramCounter);
};
