...
void setPixelsFromGrid()
{
    for (int x = 0; x < screenWidth; x++)
    {
        for (int y = 0; y < screenHeight; y++)
        {
            ...
            pixels[y * screenWidth + x] = grid[gridY * width + gridX];
        }
    }
}
...
int main()
{
    ...
    */
    ...
    GraphicBuffer *screenBuffer = new GraphicBuffer(pixels, screenHeight, screenWidth);
            ...
            for (y = 0; y < height; y++)
            {
                ...
                for (i = 0; i < matrixSize; i++)
                {
                    for (j = 0; j < matrixSize; j++)
                    {
                        ...
                        unsigned long gridVal = grid[gridY * width + gridX];
                        unsigned long gridRed = gridVal >> 16 & 0xFF;
                        unsigned long gridGreen = gridVal >> 8 & 0xFF;
                        unsigned long gridBlue = gridVal & 0xFF;
                ...
                */
                ...
                newGrid[p] = newRedInt << 16 | newGreenInt << 8 | newBlueInt;
            }
        }
