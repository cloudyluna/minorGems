...
inline CircularTerrainPath::CircularTerrainPath(double inRadius) : mRadius(inRadius)
{
...
inline void CircularTerrainPath::getPosition(double inTime, double *outX, double *outY)
{
...
inline void CircularTerrainPath::checkRadius()
{
    ...
    {
        printf("Radius of a CircularTerrainPath must be in [0, 0.5]\n");
