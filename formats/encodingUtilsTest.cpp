...
int main()
{
    ...
    const char *dataString = "*#$&$(@KFI#*$(SDBM@#*!(@%"
                             "*#$&$(@KFI#*$(SDBM@#*!(@%"
                             "*#$&$(@KFI#*$(SDBM@#*!(@F"
                             "*#$&$(@KFI#*$(SDBM@#*!(@F"
                             "*#$&$(@KFI#*$(SDBM@#*!(@F"
    ...
    char *encoding = base64Encode((unsigned char *)dataString, strlen(dataString), true);
    ...
    int compLength;
    unsigned char *compressed = zipCompress((unsigned char *)dataString, strlen(dataString) + 1, &compLength);

    if (compressed != NULL)
    {

        unsigned char *rawData = zipDecompress(compressed, compLength, strlen(dataString) + 1);
