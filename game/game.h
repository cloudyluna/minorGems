...
void playSoundSprite(SoundSpriteHandle inHandle, double inVolumeTweak = 1.0, double inStereoPosition = 0.5);
...
void saveScreenShot(const char *inPrefix, Image **outImage = NULL);
