...
class Object3D : public Serializable
{
  ...
  public:
     ...
     */
    Object3D(long inNumPrimitives, Primitive3D **inPrimitives, Transform3D **inTransform);
...
inline Object3D::Object3D(long inNumPrimitives, Primitive3D **inPrimitives, Transform3D **inTransform)
    : mNumPrimitives(inNumPrimitives), mPrimitives(inPrimitives), mTransform(inTransform), mMembersAllocated(true)
{
}

inline Object3D::Object3D() : mMembersAllocated(false)
{
}
...
inline int Object3D::serialize(OutputStream *inOutputStream)
{
    ...
    for (i = 0; i < mNumPrimitives; i++)
    {
        ...
        long typeFlag = Primitive3DFactory::primitive3DToInt(mPrimitives[i]);
...
inline int Object3D::deserialize(InputStream *inInputStream)
{
    ...
    for (i = 0; i < mNumPrimitives; i++)
    {
        ...
        mPrimitives[i] = Primitive3DFactory::intToPrimitive3D(typeFlag);
