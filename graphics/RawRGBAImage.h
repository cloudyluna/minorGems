...
class RawRGBAImage
{
  ...
  public:
    ...
    RawRGBAImage(unsigned char *inRGBABytes, int inWidth, int inHeight, int inNumChannels)
        : mRGBABytes(inRGBABytes), mWidth(inWidth), mHeight(inHeight), mNumChannels(inNumChannels)
    {
    }
