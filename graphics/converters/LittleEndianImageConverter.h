...
class LittleEndianImageConverter : public ImageConverter
{
  ...
  protected:
     ...
     */
    void writeLittleEndianLong(long inLong, OutputStream *inStream);
     ...
     */
    void writeLittleEndianShort(short inShort, OutputStream *inStream);
...
inline void LittleEndianImageConverter::writeLittleEndianLong(long inLong, OutputStream *inStream)
{
...
inline long LittleEndianImageConverter::readLittleEndianLong(InputStream *inStream)
{
    ...
    long outLong = buffer[0] | (buffer[1] << 8) | (buffer[2] << 16) | (buffer[3] << 24);

    return outLong;
}

inline void LittleEndianImageConverter::writeLittleEndianShort(short inShort, OutputStream *inStream)
{
...
inline short LittleEndianImageConverter::readLittleEndianShort(InputStream *inStream)
{
