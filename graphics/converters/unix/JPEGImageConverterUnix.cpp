...
void JPEGImageConverter::formatImage(Image *inImage, OutputStream *inStream)
{
    ...
    while (cinfo.next_scanline < cinfo.image_height)
    {
        ...
        for (int p = 0; p < cinfo.image_width; p++)
        {
            ...
            // red
            row_pointer[0][startRowIndex] = (JSAMPLE)(lrint(redChannel[pixelIndex] * 255));
            // green
            row_pointer[0][startRowIndex + 1] = (JSAMPLE)(lrint(greenChannel[pixelIndex] * 255));
            // blue
            row_pointer[0][startRowIndex + 2] = (JSAMPLE)(lrint(blueChannel[pixelIndex] * 255));
        }
    ...
    inStream->write(fileBuffer, fileLength);
    ...
    */
    ...
    while (cinfo.output_scanline < cinfo.output_height)
    {
        ...
        for (int p = 0; p < cinfo.output_width; p++)
        {
            ...
            // red
            redChannel[pixelIndex] = buffer[0][startRowIndex] * inv255;
            // green
            greenChannel[pixelIndex] = buffer[0][startRowIndex + 1] * inv255;
            // blue
            blueChannel[pixelIndex] = buffer[0][startRowIndex + 2] * inv255;
        }
