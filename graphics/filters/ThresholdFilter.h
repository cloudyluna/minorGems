...
inline ThresholdFilter::ThresholdFilter(double inThreshold) : mThreshold(inThreshold)
{
}
...
inline void ThresholdFilter::apply(double *inChannel, int inWidth, int inHeight)
{
