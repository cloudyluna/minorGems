...
inline DirectionLightingGL::DirectionLightingGL(Color *inColor, Vector3D *inDirection)
...
inline void DirectionLightingGL::getLighting(Vector3D *inPoint, Vector3D *inNormal, Color *outColor)
{
