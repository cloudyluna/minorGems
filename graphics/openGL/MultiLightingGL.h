...
inline MultiLightingGL::MultiLightingGL() : mLightingVector(new SimpleVector<LightingGL *>())
{
}
...
inline void MultiLightingGL::getLighting(Vector3D *inPoint, Vector3D *inNormal, Color *outColor)
{
