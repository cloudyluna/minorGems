 ...
 * @author Jason Rohrer
 */
class SceneNavigatorDisplayGL : public ScreenGL,
                                ...
                                public RedrawListenerGL
{
  ...
  public:
     ...
     */
    SceneNavigatorDisplayGL(int inWide, int inHigh, char inFullScreen, char *inWindowName,
                            SceneHandlerGL *inSceneHandler, double inMoveUnitsPerSecond = 1.0,
...
inline SceneNavigatorDisplayGL::SceneNavigatorDisplayGL(int inWide, int inHigh, char inFullScreen, char *inWindowName,
                                                        SceneHandlerGL *inSceneHandler, double inMoveUnitsPerSecond,
                                                        double inRotateRadiansPerSecond)

    : ScreenGL(inWide, inHigh, inFullScreen, inWindowName, NULL, NULL, inSceneHandler),
      mMoveDirection(new Vector3D(0, 0, 0)), mRotationOffset(new Angle3D(0, 0, 0)), mMoving(false), mRotating(false),
      mYMovement(0), mMoveUnitsPerSecond(inMoveUnitsPerSecond), mRotateRadiansPerSecond(inRotateRadiansPerSecond)
{
...
inline void SceneNavigatorDisplayGL::keyPressed(unsigned char inKey, int inX, int inY)
{
...
inline void SceneNavigatorDisplayGL::keyReleased(unsigned char inKey, int inX, int inY)
{
...
inline void SceneNavigatorDisplayGL::specialKeyPressed(int inKey, int inX, int inY)
{
}

inline void SceneNavigatorDisplayGL::specialKeyReleased(int inKey, int inX, int inY)
{
}
...
inline void SceneNavigatorDisplayGL::fireRedraw()
{
    ...
    unsigned long deltaMS = Time::getMillisecondsSince(mTimeLastRedrawS, mTimeLastRedrawMS);
