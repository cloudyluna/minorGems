...
class SingleTextureGL
{
  ...
  public:
     ...
     */
    SingleTextureGL(Image *inImage, char inRepeat = true, char inMipMap = false);

    /**
     * Specifies texture data as rgba bytes.
     */
    SingleTextureGL(unsigned char *inRGBA, unsigned int inWidth, unsigned int inHeight, char inRepeat = true,
                    char inMipMap = false);
     ...
     */
    SingleTextureGL(char inAlphaOnly, unsigned char *inA, unsigned int inWidth, unsigned int inHeight,
                    char inRepeat = true, char inMipMap = false);
     ...
     */
    void replaceTextureData(unsigned char *inBytes, char inAlphaOnly, unsigned int inWidth, unsigned int inHeight);
     ...
     */
    void setTextureData(unsigned char *inBytes, char inAlphaOnly, unsigned int inWidth, unsigned int inHeight,
  ...
  private:
    ...
    void replaceBackupData(unsigned char *inBytes, char inAlphaOnly, unsigned int inWidth, unsigned int inHeight);
