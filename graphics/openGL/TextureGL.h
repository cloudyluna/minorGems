...
class TextureGL
{
  ...
  public:
     ...
     */
    void setTextureData(int inLayer, unsigned char *inData, int inWide, int inHigh);
...
GLenum TextureGL::sMultiTextureEnum[MAX_NUM_LAYERS] = {GL_TEXTURE0_ARB, GL_TEXTURE1_ARB, GL_TEXTURE2_ARB,
                                                       GL_TEXTURE3_ARB, GL_TEXTURE4_ARB, GL_TEXTURE5_ARB,
                                                       GL_TEXTURE6_ARB, GL_TEXTURE7_ARB};

inline TextureGL::TextureGL(int inNumLayers) : mNumLayers(inNumLayers), mTextureID(new unsigned int[inNumLayers])
{
...
inline void TextureGL::setTextureData(int inLayer, unsigned char *inData, int inWide, int inHigh)
{
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, texFormat, inWide, inHigh, 0, texFormat, GL_UNSIGNED_BYTE, inData);
}
