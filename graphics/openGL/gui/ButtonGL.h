...
class ButtonGL : public GUIComponentGL, public ActionListenerList
{
  ...
  protected:
     ...
     */
    ButtonGL(double inAnchorX, double inAnchorY, double inWidth, double inHeight);
...
inline ButtonGL::ButtonGL(double inAnchorX, double inAnchorY, double inWidth, double inHeight)
    : GUIComponentGL(inAnchorX, inAnchorY, inWidth, inHeight), mPressed(false), mHover(false), mPressStartedOnUs(false)
{
}
