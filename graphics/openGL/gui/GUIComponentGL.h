...
class GUIComponentGL : public GUIComponent, public RedrawListenerGL
{
  ...
  public:
     ...
     */
    void setPosition(double inAnchorX, double inAnchorY, double inWidth, double inHeight);
  ...
  protected:
     ...
     * @param inHeight the height of this component.
     */
    GUIComponentGL(double inAnchorX, double inAnchorY, double inWidth, double inHeight);
...
inline GUIComponentGL::GUIComponentGL(double inAnchorX, double inAnchorY, double inWidth, double inHeight)
    : mAnchorX(inAnchorX), mAnchorY(inAnchorY), mWidth(inWidth), mHeight(inHeight), mEnabled(true), mFocusLocked(false)
{
}
...
inline void GUIComponentGL::setPosition(double inAnchorX, double inAnchorY, double inWidth, double inHeight)
{
...
{
    if (inX >= mAnchorX && inX < mAnchorX + mWidth && inY >= mAnchorY && inY < mAnchorY + mHeight)
    {
...
inline void GUIComponentGL::keyPressed(unsigned char inKey, double inX, double inY)
{
}

inline void GUIComponentGL::specialKeyPressed(int inKey, double inX, double inY)
{
}

inline void GUIComponentGL::keyReleased(unsigned char inKey, double inX, double inY)
{
}

inline void GUIComponentGL::specialKeyReleased(int inKey, double inX, double inY)
{
}
