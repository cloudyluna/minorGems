...
class GUIContainerGL : public GUIComponentGL
{
  ...
  public:
     ...
     */
    GUIContainerGL(double inAnchorX, double inAnchorY, double inWidth, double inHeight);
...
inline GUIContainerGL::GUIContainerGL(double inAnchorX, double inAnchorY, double inWidth, double inHeight)
    : GUIComponentGL(inAnchorX, inAnchorY, inWidth, inHeight), mComponentVector(new SimpleVector<GUIComponentGL *>()),
...
inline void GUIContainerGL::mouseReleased(double inX, double inY)
{
    ...
    for (int i = 0; i < mComponentVector->size(); i++)
    {
        ...
        if (i < mComponentVector->size())
        {
            ...
            if (component->isInside(inX, inY) && component->isEnabled() && *(mPressStartedHereVector->getElement(i)))
            {
...
inline void GUIContainerGL::keyPressed(unsigned char inKey, double inX, double inY)
{
...
inline void GUIContainerGL::specialKeyPressed(int inKey, double inX, double inY)
{
...
inline void GUIContainerGL::keyReleased(unsigned char inKey, double inX, double inY)
{
...
inline void GUIContainerGL::specialKeyReleased(int inKey, double inX, double inY)
{
