...
class GUIPanelGL : public GUIContainerGL
{
  ...
  public:
     ...
     */
    GUIPanelGL(double inAnchorX, double inAnchorY, double inWidth, double inHeight, Color *inColor);
...
inline GUIPanelGL::GUIPanelGL(double inAnchorX, double inAnchorY, double inWidth, double inHeight, Color *inColor)
    : GUIContainerGL(inAnchorX, inAnchorY, inWidth, inHeight), mColor(inColor)
{
}
