 ...
 * @author Jason Rohrer
 */
class GUITranslatorGL : public MouseHandlerGL, public KeyboardHandlerGL, public SceneHandlerGL
{
  ...
  public:
     ...
     *   centered.
     */
    GUITranslatorGL(GUIComponentGL *inComponent, ScreenGL *inScreen, double inMaxDimension = 1.0);
...
inline GUITranslatorGL::GUITranslatorGL(GUIComponentGL *inComponent, ScreenGL *inScreen, double inMaxDimension)
    : mComponent(inComponent), mScreen(inScreen), mMaxDimension(inMaxDimension)
{
}
...
inline void GUITranslatorGL::translate(int inX, int inY, double *outX, double *outY)
{
...
inline void GUITranslatorGL::keyPressed(unsigned char inKey, int inX, int inY)
{
    mComponent->keyPressed(inKey, translateX(inX), translateY(inY));
}

inline void GUITranslatorGL::specialKeyPressed(int inKey, int inX, int inY)
{
    mComponent->specialKeyPressed(inKey, translateX(inX), translateY(inY));
}

inline void GUITranslatorGL::keyReleased(unsigned char inKey, int inX, int inY)
{
    mComponent->keyReleased(inKey, translateX(inX), translateY(inY));
}

inline void GUITranslatorGL::specialKeyReleased(int inKey, int inX, int inY)
{
    mComponent->specialKeyReleased(inKey, translateX(inX), translateY(inY));
}
...
inline void GUITranslatorGL::drawScene()
{
    ...
    glOrtho(0, mMaxDimension, 0, mMaxDimension, zStart, zEnd);
