...
class StickyButtonGL : public ButtonGL
{
  ...
  public:
     ...
     *   Will be destroyed when this class is destroyed.
     */
    StickyButtonGL(double inAnchorX, double inAnchorY, double inWidth, double inHeight, Image *inUnpressedImage,
...
inline StickyButtonGL::StickyButtonGL(double inAnchorX, double inAnchorY, double inWidth, double inHeight,
                                      Image *inUnpressedImage, Image *inPressedImage)
    : ButtonGL(inAnchorX, inAnchorY, inWidth, inHeight, inUnpressedImage, inPressedImage)
{
}
