...
class COMPort
{
  public:
    ...
    unsigned long read(void *, const unsigned long count);

    unsigned long write(const void *, const unsigned long count);
    ...
    COMPort &setBlockingMode(unsigned long inReadInterval = 0, unsigned long inReadMultiplyer = 0,
