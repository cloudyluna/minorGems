...
class BinaryLogicExpression : public BinaryOperationExpression
{
  ...
  public:
     ...
     */
    BinaryLogicExpression(int inLogicOperation, Expression *inArgumentA, Expression *inArgumentB);
...
inline BinaryLogicExpression::BinaryLogicExpression(int inLogicOperation, Expression *inArgumentA,
                                                    Expression *inArgumentB)
    : BinaryOperationExpression(inArgumentA, inArgumentB), mLogicOperation(inLogicOperation)
{
}
...
{
    BinaryLogicExpression *copy = new BinaryLogicExpression(mLogicOperation, mArgumentA->copy(), mArgumentB->copy());
    return copy;
}
