...
class BinaryOperationExpression : public Expression
{
  ...
  public:
     ...
     * @param inArgumentA the first argument.  Defaults to NULL.
     */
    BinaryOperationExpression(Expression *inArgumentA = NULL, Expression *inArgumentB = NULL);
...
inline BinaryOperationExpression::BinaryOperationExpression(Expression *inArgumentA, Expression *inArgumentB)
...
inline Expression *BinaryOperationExpression::getArgument(long inArgumentNumber)
{
...
inline void BinaryOperationExpression::setArgument(long inArgumentNumber, Expression *inArgument)
{
...
inline Expression *BinaryOperationExpression::extractArgument(long inArgumentNumber)
{
