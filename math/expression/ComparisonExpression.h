...
class ComparisonExpression : public BinaryOperationExpression
{
  ...
  public:
     ...
     */
    ComparisonExpression(int inComparison, Expression *inArgumentA, Expression *inArgumentB);
...
inline ComparisonExpression::ComparisonExpression(int inComparison, Expression *inArgumentA, Expression *inArgumentB)
    : BinaryOperationExpression(inArgumentA, inArgumentB), mComparison(inComparison)
{
}
...
{
    ComparisonExpression *copy = new ComparisonExpression(mComparison, mArgumentA->copy(), mArgumentB->copy());
    return copy;
}
