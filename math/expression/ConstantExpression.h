...
inline ConstantExpression::ConstantExpression(double inValue) : mValue(inValue)
{
}
...
inline Expression *ConstantExpression::getArgument(long inArgumentNumber)
{

    return NULL;
}

inline void ConstantExpression::setArgument(long inArgumentNumber, Expression *inArgument)
{
...
inline Expression *ConstantExpression::extractArgument(long inArgumentNumber)
{
