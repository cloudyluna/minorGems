...
inline FixedConstantExpression::FixedConstantExpression(double inValue) : mValue(inValue)
{
}
...
inline Expression *FixedConstantExpression::getArgument(long inArgumentNumber)
{

    return NULL;
}

inline void FixedConstantExpression::setArgument(long inArgumentNumber, Expression *inArgument)
{
...
inline Expression *FixedConstantExpression::extractArgument(long inArgumentNumber)
{
