...
class MultiConstantArgumentExpression : public Expression
{
  ...
  public:
    ...
    virtual void setArgument(long inArgumentNumber, Expression *inArgument);
  ...
  protected:
     ...
     */
    long findConstants(Expression *inExpression, ConstantExpression ***outExpressions);
     ...
     */
    void findConstantsRecursive(Expression *inExpression, SimpleVector<ConstantExpression *> *inConstantVector);
};

// static init
long MultiConstantArgumentExpression::mID = 8;

inline MultiConstantArgumentExpression::MultiConstantArgumentExpression(Expression *inExpression)
...
inline MultiConstantArgumentExpression::~MultiConstantArgumentExpression()
{
...
inline void MultiConstantArgumentExpression::setWrappedExpression(Expression *inExpression)
{
...
inline Expression *MultiConstantArgumentExpression::getWrappedExpression()
{
    return mExpression;
}

inline Expression *MultiConstantArgumentExpression::extractWrappedExpression()
{
...
inline Expression *MultiConstantArgumentExpression::getArgument(long inArgumentNumber)
{
...
inline void MultiConstantArgumentExpression::setArgument(long inArgumentNumber, Expression *inArgument)
{
    ...
    if (expressionToSet != NULL)
    {
        ...
        ConstantExpression *constantExpression = (ConstantExpression *)expressionToSet;
...
inline Expression *MultiConstantArgumentExpression::extractArgument(long inArgumentNumber)
{
...
inline long MultiConstantArgumentExpression::findConstants(Expression *inExpression,
                                                           ConstantExpression ***outExpressions)
{

    SimpleVector<ConstantExpression *> *constantVector = new SimpleVector<ConstantExpression *>();

    findConstantsRecursive(inExpression, constantVector);

    long numConstants = constantVector->size();

    ConstantExpression **returnArray = new ConstantExpression *[numConstants];
...
inline void MultiConstantArgumentExpression::findConstantsRecursive(
    Expression *inExpression, SimpleVector<ConstantExpression *> *inConstantVector)
{
