...
class PowerExpression : public BinaryOperationExpression
{
  ...
  public:
     ...
     */
    PowerExpression(Expression *inArgumentA, Expression *inArgumentB);
...
inline PowerExpression::PowerExpression(Expression *inArgumentA, Expression *inArgumentB)
...
{
    PowerExpression *copy = new PowerExpression(mArgumentA->copy(), mArgumentB->copy());
    return copy;
}
