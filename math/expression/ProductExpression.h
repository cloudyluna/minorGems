...
class ProductExpression : public BinaryOperationExpression
{
  ...
  public:
     ...
     */
    ProductExpression(Expression *inArgumentA, Expression *inArgumentB);
...
inline ProductExpression::ProductExpression(Expression *inArgumentA, Expression *inArgumentB)
...
{
    ProductExpression *copy = new ProductExpression(mArgumentA->copy(), mArgumentB->copy());
    return copy;
}
