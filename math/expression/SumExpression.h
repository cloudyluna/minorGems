...
class SumExpression : public BinaryOperationExpression
{
  ...
  public:
     ...
     */
    SumExpression(Expression *inArgumentA, Expression *inArgumentB);
...
inline SumExpression::SumExpression(Expression *inArgumentA, Expression *inArgumentB)
...
{
    SumExpression *copy = new SumExpression(mArgumentA->copy(), mArgumentB->copy());
    return copy;
}
