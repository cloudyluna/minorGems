...
inline UnaryOperationExpression::UnaryOperationExpression(Expression *inArgument) : mArgument(inArgument)
{
}
...
inline Expression *UnaryOperationExpression::getArgument(long inArgumentNumber)
{
...
inline void UnaryOperationExpression::setArgument(long inArgumentNumber, Expression *inArgument)
{
...
inline Expression *UnaryOperationExpression::extractArgument(long inArgumentNumber)
{
