...
class VariableExpression : public Expression
{
  ...
  public:
    ...
    virtual void replaceVariable(Variable *inTarget, Variable *inReplacement);
...
inline VariableExpression::VariableExpression(Variable *inVariable) : mVariable(inVariable)
{
}
...
inline Expression *VariableExpression::copy()
{
    ...
    VariableExpression *copy = new VariableExpression(mVariable);
...
inline Expression *VariableExpression::getArgument(long inArgumentNumber)
{

    return NULL;
}

inline void VariableExpression::setArgument(long inArgumentNumber, Expression *inArgument)
{
...
inline Expression *VariableExpression::extractArgument(long inArgumentNumber)
{

    return NULL;
}

inline void VariableExpression::replaceVariable(Variable *inTarget, Variable *inReplacement)
{
