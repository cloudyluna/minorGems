...
int main()
{
    ...
    ProductExpression *expression =
        new ProductExpression(new PowerExpression(new ConstantExpression(5), new ConstantExpression(6)),
                              new NegateExpression(new SinExpression(new ConstantExpression(19))));

    InvertExpression *invExpression = new InvertExpression(expression);

    SumExpression *sumExpression = new SumExpression(invExpression, new ConstantExpression(2));
    ...
    ExpressionSerializer::deserializeExpression(&readExpression, inStream);
