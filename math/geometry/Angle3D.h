...
class Angle3D : public Serializable
{
  ...
  public:
     ...
     */
    static Angle3D *linearSum(Angle3D *inFirst, Angle3D *inSecond, double inFirstWeight);
...
inline Angle3D::Angle3D(double inX, double inY, double inZ) : mX(inX), mY(inY), mZ(inZ)
{
}

inline Angle3D::Angle3D() : mX(0), mY(0), mZ(0)
{
}

inline Angle3D::Angle3D(Angle3D *inOther) : mX(inOther->mX), mY(inOther->mY), mZ(inOther->mZ)
{
}
...
{
    setComponents(inOther->mX, inOther->mY, inOther->mZ);
}
...
inline Angle3D *Angle3D::linearSum(Angle3D *inFirst, Angle3D *inSecond, double inFirstWeight)
{
