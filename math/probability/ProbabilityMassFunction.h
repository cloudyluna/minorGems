...
class ProbabilityMassFunction
{
  ...
  public:
     ...
     *   Destroyed by caller
     */
    ProbabilityMassFunction(RandomSource *inRandSource, int inNumElements, double *inProbabilities);
     ...
     */
    virtual void setProbability(int inIndex, double inProbability);
...
inline ProbabilityMassFunction::ProbabilityMassFunction(RandomSource *inRandSource)
    : mRandSource(inRandSource), mProbabilityVector(new SimpleVector<double>())
{
}

inline ProbabilityMassFunction::ProbabilityMassFunction(RandomSource *inRandSource, int inNumElements,
                                                        double *inProbabilities)
    : mRandSource(inRandSource), mProbabilityVector(new SimpleVector<double>(inNumElements))
{
...
inline int ProbabilityMassFunction::addElement(double inProbability)
{
...
inline void ProbabilityMassFunction::removeElement(int inIndex)
{
...
inline double ProbabilityMassFunction::getProbability(int inIndex)
{
...
inline void ProbabilityMassFunction::setProbability(int inIndex, double inProbability)
{
...
inline int ProbabilityMassFunction::sampleElement()
{
    ...
    while (currentCDFVal < randVal && currentIndex < numValues - 1)
    {

        currentIndex++;

        double currentProb = *(mProbabilityVector->getElement(currentIndex));
