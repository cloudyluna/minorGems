...
class WebClient
{
  ...
  public:
     ...
     */
    static char *getWebPage(char *inURL, int *outContentLength, char **outFinalURL = NULL, char **outMimeType = NULL,
     ...
     *   Must be destroyed by caller if non-NULL.
     */
    static char *getWebPagePOST(char *inURL, char *inPostBody, int *outContentLength, char **outFinalURL = NULL,
                                char **outMimeType = NULL, long inTimeoutInMilliseconds = -1);
  ...
  protected:
     ...
     *   Must be destroyed by caller.
     */
    static char *receiveData(SocketStream *inSocketStream, int *outContentLength);
     ...
     *   Must be destroyed by caller if non-NULL.
     */
    static char *executeWebMethod(const char *inMethod, char *inURL, char *inBody, int *outContentLength,
                                  char **outFinalURL = NULL, char **outMimeType = NULL,
                                  long inTimeoutInMilliseconds = -1);
};
