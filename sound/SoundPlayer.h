...
class SampleSource
{
  ...
  public:
     ...
     *   in seconds.
     */
    virtual void getSamples(int inNumSamples, float *outSampleBuffer, double inPlayTime) = 0;
};
...
class SoundPlayer
{
  ...
  public:
     ...
     */
    SoundPlayer(int inSampleRate, char inStereo, SampleSource *inSampleSource);
