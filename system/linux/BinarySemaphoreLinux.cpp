...
BinarySemaphore::BinarySemaphore() : mSemaphoreValue(0)
{
    ...
    pthread_cond_t *condPointer = (pthread_cond_t *)mNativeObjectPointerA;
    ...
    pthread_mutex_t *mutexPointer = (pthread_mutex_t *)mNativeObjectPointerB;
...
int BinarySemaphore::wait(int inTimeoutInMilliseconds)
{
    ...
    if (mSemaphoreValue == 0)
    {
        ...
        else
        {
            ...
            int result = pthread_cond_timedwait(&(condPointer[0]), &(mutexPointer[0]), &abstime);
