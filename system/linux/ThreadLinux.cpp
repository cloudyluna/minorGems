...
// prototype
int gprof_pthread_create(pthread_t *thread, pthread_attr_t *attr, void *(*start_routine)(void *), void *arg);
#endif
...
#ifdef USE_GPROF_THREADS
    gprof_pthread_create(&(threadPointer[0]), NULL, linuxThreadFunction, (void *)this);
#else
    pthread_create(&(threadPointer[0]), NULL, linuxThreadFunction, (void *)this);
#endif
...
void Thread::staticSleep(unsigned long inTimeInMilliseconds)
{
    ...
    while (sleepReturn == -1)
    {
        ...
        sleepReturn = nanosleep(&timeToSleepStruct, &remainingSleepTimeStruct);
    }
}
