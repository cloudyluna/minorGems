...
inline WaitingThread::WaitingThread(int inID, Semaphore *inSemaphore) : mID(inID), mSemaphore(inSemaphore)
{
}
...
inline SignalingThread::SignalingThread(Semaphore *inSemaphore) : mSemaphore(inSemaphore)
{
}
