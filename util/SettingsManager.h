...
class SettingsManager
{
  ...
  public:
    ...
    static SimpleVector<int> *getIntSettingMulti(const char *inSettingName);

    static SimpleVector<float> *getFloatSettingMulti(const char *inSettingName);

    static SimpleVector<double> *getDoubleSettingMulti(const char *inSettingName);
    ...
    static char *getStringSetting(const char *inSettingName, const char *inDefaultValue);
    ...
    // same as above, but never returns NULL
    // if setting cannot be read, returns copy of inDefaultValue
    static char *getSettingContents(const char *inSettingName, const char *inDefaultValue);
     ...
     */
    static float getFloatSetting(const char *inSettingName, char *outValueFound);

    /**
     * Returns default value if setting not found.
     */
    static float getFloatSetting(const char *inSettingName, float inDefaultValue);
     ...
     * @return the setting value.
     */
    static double getDoubleSetting(const char *inSettingName, char *outValueFound);

    /**
     * Returns default value if setting not found.
     */
    static double getDoubleSetting(const char *inSettingName, double inDefaultValue);
     ...
     * @return the setting value.
     */
    static int getIntSetting(const char *inSettingName, char *outValueFound);

    /**
     * Returns default value if setting not found.
     */
    static int getIntSetting(const char *inSettingName, int inDefaultValue);

    /**
     * Returns seconds since GMT epoch.
     */
    static timeSec_t getTimeSetting(const char *inSettingName, timeSec_t inDefaultValue);
     ...
     *   by the caller.
     */
    static void setSetting(const char *inSettingName, SimpleVector<char *> *inSettingVector);
     ...
     */
    static void setSetting(const char *inSettingName, float inSettingValue);
     ...
     * @param inSettingValue the value to set.
     */
    static void setDoubleSetting(const char *inSettingName, double inSettingValue);
     ...
     * @param inSettingValue the value to set.
     */
    static void setSetting(const char *inSettingName, int inSettingValue);
     ...
     * @param inSettingValue the value to set.
     */
    static void setSetting(const char *inSettingName, timeSec_t inSettingValue);
     ...
     *   Must be destroyed by caller.
     */
    static void setSetting(const char *inSettingName, const char *inSettingValue);
     ...
     */
    static FILE *getSettingsFile(const char *inSettingName, const char *inReadWriteFlags);
  ...
  protected:
     ...
     *   Must be destroyed by caller.
     */
    static char *getSettingsFileName(const char *inSettingName, const char *inExtension);
};
