...
class TranslationManager
{
  ...
  public:
     ...
     */
    static void setLanguage(const char *inLanguageName, char inClearOldKeys = true);
    ...
    static void setLanguageData(const char *inData, char inClearOldKeys = true);
...
class TranslationManagerStaticMembers
{
  ...
  public:
     ...
     *   Must be destroyed by caller.
     */
    void setDirectoryAndLanguage(const char *inDirectoryName, const char *inLanguageName, char inClearOldKeys = true);

    // sets the data from a string
    // string contains same contents as a language file
    // string destroyed by caller
    void setTranslationData(const char *inData, char inClearOldKeys = true);
