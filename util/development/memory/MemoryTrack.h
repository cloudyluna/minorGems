...
class MemoryTrack
{
  ...
  public:
     ...
     */
    static void addAllocation(void *inPointer, unsigned int inAllocationSize, int inAllocationType,
  ...
  public:
    MemoryTrackStaticInitCounter()
    {
        if (mCount == 0)
        {
            ...
            MemoryTrack::mListHead = (AllocationList *)malloc(sizeof(AllocationList));
