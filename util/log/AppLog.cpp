...
LogPointerWrapper::LogPointerWrapper(Log *inLog) : mLog(inLog)
{
}
...
{
    mLogPointerWrapper.mLog->logString(Log::CRITICAL_ERROR_LEVEL, inString);
}
...
void AppLog::criticalErrorF(const char *inFormatString, ...)
{
    ...
    mLogPointerWrapper.mLog->logStringV(Log::CRITICAL_ERROR_LEVEL, inFormatString, argList);

    va_end(argList);
}

void AppLog::criticalError(const char *inLoggerName, const char *inFormatString, ...)
{
    va_list argList;
    va_start(argList, inFormatString);

    mLogPointerWrapper.mLog->logStringV(inLoggerName, Log::CRITICAL_ERROR_LEVEL, inFormatString, argList);
...
void AppLog::errorF(const char *inFormatString, ...)
{
    ...
    mLogPointerWrapper.mLog->logStringV(Log::ERROR_LEVEL, inFormatString, argList);

    va_end(argList);
}

void AppLog::error(const char *inLoggerName, const char *inFormatString, ...)
{
    va_list argList;
    va_start(argList, inFormatString);

    mLogPointerWrapper.mLog->logStringV(inLoggerName, Log::ERROR_LEVEL, inFormatString, argList);
...
void AppLog::warningF(const char *inFormatString, ...)
{
    ...
    mLogPointerWrapper.mLog->logStringV(Log::WARNING_LEVEL, inFormatString, argList);

    va_end(argList);
}

void AppLog::warning(const char *inLoggerName, const char *inFormatString, ...)
{
    va_list argList;
    va_start(argList, inFormatString);

    mLogPointerWrapper.mLog->logStringV(inLoggerName, Log::WARNING_LEVEL, inFormatString, argList);
...
void AppLog::infoF(const char *inFormatString, ...)
{
    ...
    mLogPointerWrapper.mLog->logStringV(Log::INFO_LEVEL, inFormatString, argList);

    va_end(argList);
}

void AppLog::info(const char *inLoggerName, const char *inFormatString, ...)
{
    va_list argList;
    va_start(argList, inFormatString);

    mLogPointerWrapper.mLog->logStringV(inLoggerName, Log::INFO_LEVEL, inFormatString, argList);
...
void AppLog::detailF(const char *inFormatString, ...)
{
    ...
    mLogPointerWrapper.mLog->logStringV(Log::DETAIL_LEVEL, inFormatString, argList);

    va_end(argList);
}

void AppLog::detail(const char *inLoggerName, const char *inFormatString, ...)
{
    va_list argList;
    va_start(argList, inFormatString);

    mLogPointerWrapper.mLog->logStringV(inLoggerName, Log::DETAIL_LEVEL, inFormatString, argList);
...
void AppLog::traceF(const char *inFormatString, ...)
{
    ...
    mLogPointerWrapper.mLog->logStringV(Log::TRACE_LEVEL, inFormatString, argList);

    va_end(argList);
}

void AppLog::trace(const char *inLoggerName, const char *inFormatString, ...)
{
    va_list argList;
    va_start(argList, inFormatString);

    mLogPointerWrapper.mLog->logStringV(inLoggerName, Log::TRACE_LEVEL, inFormatString, argList);
