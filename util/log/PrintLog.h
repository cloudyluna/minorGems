...
class PrintLog : public Log
{
  ...
  public:
    ...
    virtual void logString(const char *inLoggerName, int inLevel, const char *inFormatString, ...);

    virtual void logStringV(int inLevel, const char *inFormatString, va_list inArgList);

    virtual void logStringV(const char *inLoggerName, int inLevel, const char *inFormatString, va_list inArgList);
  ...
  protected:
    ...
    char *generatePlainMessage(const char *inFormatString, va_list inArgList);
     ...
     *   Must be destroyed by caller.
     */
    char *generateLogMessage(const char *inLoggerName, int inLevel, const char *inFormatString, va_list inArgList);
};
