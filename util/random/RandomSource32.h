...
inline int RandomSource32::getRandomBoundedInt(int inRangeStart, int inRangeEnd)
{
...
inline double RandomSource32::getRandomBoundedDouble(double inRangeStart, double inRangeEnd)
{
