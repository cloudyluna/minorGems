...
class StdRandomSource : public RandomSource
{
  ...
  public:
    ...
    int getRandomBoundedInt(int inRangeStart, int inRangeEnd);

    double getRandomBoundedDouble(double inRangeStart, double inRangeEnd);
...
inline int StdRandomSource::getRandomBoundedInt(int inRangeStart, int inRangeEnd)
{
...
inline double StdRandomSource::getRandomBoundedDouble(double inRangeStart, double inRangeEnd)
{
